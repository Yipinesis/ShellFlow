...
## The Basics
First, we'll have to go over the basics. ShellFlow is currently in `V1.0.0` as of righting this, so expect things to not function correctly. However, if your version is in `V1.X.X`, then this guide should still be up to date. Anyway, enough blabbering. First, you'll have to go the
